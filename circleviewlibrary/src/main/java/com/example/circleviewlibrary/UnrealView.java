...
public class UnrealView extends FrameLayout {
    ...
    public UnrealView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        initView(context);
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.UnrealView);
        mCount = a.getString(R.styleable.UnrealView_count2);
        mDrawable = a.getDrawable(R.styleable.UnrealView_icon2);
        a.recycle();
    }
